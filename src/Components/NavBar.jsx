//Component to display NAV BAR
const NavBar = ({ setCategory }) => {
    return (
        <nav className="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
            <div className="container-fluid">
                <a className="navbar-brand" href='/' ><span className="badge bg-light text-dark fs-4">MSQ-NEWS</span></a>
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav">
                        <li className="nav-item">
                            <div className="nav-link text-light" onClick={() => { setCategory('general') }} style={{ cursor: "pointer" }}>Home</div>
                        </li>
                        <li className="nav-item">
                        ...
                        <li className="nav-item">
                            <div className="nav-link position-fixed top-20 end-0 text-light" ><marquee width="80%" direction="left" height="100p%" >
                                Welcome to MSQ-NEWS
                            </marquee></div>
                        </li>
                    </ul>
